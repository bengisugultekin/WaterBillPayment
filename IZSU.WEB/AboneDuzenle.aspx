<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboneDuzenle.aspx.cs" Inherits="IZSU.WEB.AboneDuzenle" %>
...
<body>
    ...
    <div class="container">
        <h1 class="alert alert-info" role="alert">Abone Bilgi Düzenle</h1>
        <br />
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                ...
                <input type="number" id="AboneNo"  runat="server" placeholder="e.g. 1" class="form-control" min="1" required />
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TxtAdSoyad" runat="server" PlaceHolder="Ad Soyad" CssClass="form-control" Visible="False" required></asp:TextBox>
            </div>
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="DropDownListAboneTipi" CssClass="form-control" runat="server" Visible="False"></asp:DropDownList>
            </div>
            <div>
                <asp:Button ID="ButtonKaydet" runat="server" CssClass="btn btn-default" Text="KAYDET" Visible="False" OnClick="ButtonKaydet_Click"/>
            </div>
        </form>
    </div>
